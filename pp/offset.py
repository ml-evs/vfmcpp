...
root_list =  ['../../data/distorted_line_delayed_ring/offset_15R_dist_t0/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t4/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t8/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t12/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t16/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t20/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t24/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t28/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t32/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t36/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t40/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t44/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t48/', 
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t52/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t80/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t84/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t88/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t120/',
              '../../data/distorted_line_delayed_ring/offset_15R_dist_t124/']
...
for sigma in sigma_list:
    if os.path.isfile(sigma+'/time.dat') == True:
        lastdat = 0
...
colors = plt.cm.seismic(np.linspace(0,1,len(sigma_array)))

ax.scatter(-sigma_array, 1e6*(line_length+circumference),facecolor='None', alpha=1,label='total length', lw=0.5, marker='*',s=25)
...
for i in range(len(sigma_array)):
    ax.scatter(-sigma_array[i], 1e6*line_length[i], c=colors[i], alpha=1,lw=1, marker='v',s=25)
    ax.scatter(-sigma_array[i], 1e6*circumference[i],       c=colors[i], alpha=1, lw=1, marker='o',s=25)
    #ax.scatter(-sigma_array[i], 1e6*np.sqrt(2*np.pi*impulse_rings[i]), c=colors[i], alpha=1, lw=1, marker='o',s=20)
...
ax3 = ax.twinx()
ax3.bar(-sigma_array-0.02, killed, 0.06, color='k', alpha=0.2)
